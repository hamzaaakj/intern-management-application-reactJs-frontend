...
export default ({
  ...
  const [filiere_idInput, setfiliere_idInput] = useState(itemToEdit.filiere.id);
  const [group_idInput, setGroupe_idInput] = useState(itemToEdit.groupe_id);
                    ...
                    <select
                      ...
                      {filieres?.map((filiere, index) => {
                        return (
                          <option
                            value={filiere.id}
                            selected={filiere.id === itemToEdit.filiere.id}>
                            {filiere.name}
                          </option>
                        );
                      })}
                    ...
                    <select
                      ...
                      {groupes?.map((groupe, index) => {
                        return (
                          <option
                            value={groupe.id}
                            selected={groupe.id === itemToEdit.groupe.id}>
                            {groupe.name}
                          </option>
                        );
                      })}
