...
export default ({ filieres, groupes, setAddForm, handleAdd }) => {
  ...
  const handleGroupeSelection = (e) => {
    const values = Array.from(
      e.target.selectedOptions,
      (option) => option.value
    );
    setGroupeInput(values);
  };
              ...
              <form action="#" enctype="multipart/form-data">
                <div class="flex flex-col gap-2">
                  <div className="wrrap w-full flex gap-4">
                    <div className="wrapp w-full flex flex-col gap-5">
                      <div>
                        <label
                          for="name"
                      ...
                      <div className="CTAs w-full flex gap-2 items-center justify-between">
                        <button
                          type="button"
                    ...
                    <div className="wrap w-full">
                      ...
                      <div>
                        ...
                        <select
                          multiple
                          onChange={(e) => handleGroupeSelection(e)}
                          id="groupe"
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg   block w-full p-2.5">
